...
<div class="<?php print $classes; ?> media-vimeo-<?php print $id; ?>">
  <iframe id="media-vimeo-<?php print $video_id; ?>" class="media-vimeo-player" <?php print $api_id_attribute; ?>width="<?php print $width; ?>" height="<?php print $height; ?>" src="<?php print $url; ?>&api=1&player_id=media-vimeo-<?php print $video_id; ?>" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
</div>
<script>
  (function($){
    var iframe = $('#media-vimeo-<?php print $video_id; ?>')[0],
      player = $f(iframe);
